...
## Confusion Matrix
Differential gene expression analyses on RNA data revealed 0 significant changes in the expression of genes between a high and low biliary viability. To identify proteins and thresholds with potential as biomarkers, we filtered the dataset using a p-value cut-off of 0.05. This evaluation was performed on the 150-minute time point dataset, as no proteins met this significance threshold at the 30-minute time point. From the filtered 150-minute dataset, 14 unique thresholds were identified where proteins demonstrated statistically significant p-values (< 0.05)(Table 2). These thresholds correspond to optimal expression cut-offs used to classify samples based on protein abundance.
